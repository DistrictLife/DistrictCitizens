...
public class DLCitizensPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // Protection Forge (HIGHEST priority) — doit s'exécuter APRÈS l'init du PacketChannel
        // car Forge chargera dlclient avant onEnable, les classes sont déjà disponibles.
        new ForgeProtectionListener(this).register();
